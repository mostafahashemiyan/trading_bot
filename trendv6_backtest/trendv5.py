...
# Set to True if you want to see signal output for all strategy engines,
# not only the strategy selected by the LLM/rule-based selector.
...
def main():
    ...
    if run_all_strategies:
        all_strategy_signals = generate_all_strategy_signals(df=df, trend_data=trend_data)
        print_all_strategy_signals(all_strategy_signals)
